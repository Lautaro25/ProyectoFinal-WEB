 ...
 <div class="login_formulario">
            ...
            <form action="/svLogin" method="POST" id="loginForm" onsubmit="return validateForm()">
                ...
                <div class="login_formulario-inputs">
                    ...
                    <input type="password" name="contrasenia" class="pass" id="pass" placeholder="Ingrese su contraseña" required>
                    <p id="passwordError" style="color: red; font-size: 0.9em; display: none;">La contraseña debe tener al menos 8 caracteres.</p>
                </div>
